...
import { OuterAvatarContainer, InnerAvatarContainer, OuterProgressContainer, FullWidthStack } from "./BlockContainers";
...
export const BlockHeader = memo(({
  ...
  return (
    <FullWidthStack align="center" direction="row" spacing={1}>
      {!limitedRender ? (
