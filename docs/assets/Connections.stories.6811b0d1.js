...
Connections.args = {
  ...
  ...connectionConfig,
  ...connectionStarter
};`,locationsMap:{connections:{startLoc:{col:17,line:14},endLoc:{col:1,line:27},startBody:{col:17,line:14},endBody:{col:1,line:27}}}}},title:"Connections",component:y};const S=n=>{const{drawers:O,objectTypes:m,programData:f,executionData:D,drawerWidth:C,...p}=n,[N,T]=_();return g.exports.useLayoutEffect(()=>{E.setState({programSpec:{drawers:O,objectTypes:m},programData:f,executionData:D})}),i("div",{ref:N,style:{display:"flex",height:"100vh",flexDirection:"row",backgroundColor:p.highlightColor},children:i(y,{...p,store:E,height:T.height,width:T.width,drawerWidth:C})})},b=S.bind({});b.args={highlightColor:"#ff00ff",drawerWidth:235,snapToGrid:!0,...A,...B};const W=["Connections"];export{b as Connections,W as __namedExportsOrder,F as default};
//# sourceMappingURL=Connections.stories.6811b0d1.js.map
