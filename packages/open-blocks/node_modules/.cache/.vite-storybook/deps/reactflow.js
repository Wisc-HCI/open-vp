import {
  createStore,
  useStore
} from "./chunk-MFBIKFXV.js";
import {
  shallow
} from "./chunk-5TEHGH3L.js";
import {
  require_jsx_runtime
...
function useStore2(selector6, equalityFn) {
  ...
  return useStore(store, selector6, equalityFn);
}
var useStoreApi = () => {
  const store = (0, import_react.useContext)(StoreContext);
  if (store === null) {
...
function getClosestHandle(event, doc2, pos, connectionRadius, handles, validator) {
  ...
  const domNodes = doc2.elementsFromPoint(x, y);
...
function isValidHandle(handle, connectionMode, fromNodeId, fromHandleId, fromType, isValidConnection, doc2) {
  ...
  const handleToCheck = doc2.querySelector(`.react-flow__handle[data-id="${handle == null ? void 0 : handle.nodeId}-${handle == null ? void 0 : handle.id}-${handle == null ? void 0 : handle.type}"]`);
  const result = {
    ...defaultResult(),
...
function handlePointerDown({ event, handleId, nodeId, onConnect, isTarget, getState, setState, isValidConnection, edgeUpdaterType, onEdgeUpdateEnd }) {
  ...
  let closestHandle;
  const { x, y } = getEventPosition(event);
  const clickedHandle = doc2 == null ? void 0 : doc2.elementFromPoint(x, y);
...
var Handle = (0, import_react.forwardRef)(({ type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id: id2, onConnect, children: children2, className, onMouseDown, onTouchStart, ...rest }, ref) => {
  var _a, _b;
  ...
  const { connecting, clickConnecting } = useStore2(connectingSelector(nodeId, handleId, type), shallow);
  if (!nodeId) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, "data-id": `${nodeId}-${handleId}-${type}`, className: cc([
    "react-flow__handle",
...
function useNodes() {
  const nodes = useStore2(nodesSelector, shallow);
  return nodes;
}
var edgesSelector = (state) => state.edges;
function useEdges() {
  const edges = useStore2(edgesSelector, shallow);
  return edges;
}
...
function useNodesInitialized(options = defaultOptions) {
  const initialized = useStore2(selector(options));
  return initialized;
}
...
function MiniMapNodes({
  ...
  const nodes = useStore2(selectorNodes, shallow);
  const nodeOrigin = useStore2(selector$12);
  const nodeColorFunc = getAttrFunction(nodeColor);
  const nodeStrokeColorFunc = getAttrFunction(nodeStrokeColor);
  const nodeClassNameFunc = getAttrFunction(nodeClassName);
  const shapeRendering = typeof window === "undefined" || !!window.chrome ? "crispEdges" : "geometricPrecision";
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: nodes.map((node) => {
    const { x, y } = getNodePositionWithOrigin(node, nodeOrigin).positionAbsolute;
    return (0, import_jsx_runtime2.jsx)(NodeComponent, { x, y, width: node.width, height: node.height, style: node.style, className: nodeClassNameFunc(node), color: nodeColorFunc(node), borderRadius: nodeBorderRadius, strokeColor: nodeStrokeColorFunc(node), strokeWidth: nodeStrokeWidth, shapeRendering, onClick, id: node.id }, node.id);
  }) });
}
...
function MiniMap({
  ...
  const { boundingRect, viewBB, rfId } = useStore2(selector2, shallow);
  ...
  return (0, import_jsx_runtime2.jsx)(Panel, { position, style: style2, className: cc(["react-flow__minimap", className]), "data-testid": "rf__minimap", children: (0, import_jsx_runtime2.jsxs)("svg", { width: elementWidth, height: elementHeight, viewBox: `${x} ${y} ${width} ${height}`, role: "img", "aria-labelledby": labelledBy, ref: svg, onClick: onSvgClick, children: [ariaLabel && (0, import_jsx_runtime2.jsx)("title", { id: labelledBy, children: ariaLabel }), (0, import_jsx_runtime2.jsx)(MiniMapNodes$1, { onClick: onSvgNodeClick, nodeColor, nodeStrokeColor, nodeBorderRadius, nodeClassName, nodeStrokeWidth, nodeComponent }), (0, import_jsx_runtime2.jsx)("path", { className: "react-flow__minimap-mask", d: `M${x - offset},${y - offset}h${width + offset * 2}v${height + offset * 2}h${-width - offset * 2}z
...
var Controls = ({ style: style2, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children: children2, position = "bottom-left" }) => {
  ...
  const { isInteractive, minZoomReached, maxZoomReached } = useStore2(selector3, shallow);
  ...
  return (0, import_jsx_runtime3.jsxs)(Panel, { className: cc(["react-flow__controls", className]), position, style: style2, "data-testid": "rf__controls", children: [showZoom && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [(0, import_jsx_runtime3.jsx)(ControlButton, { onClick: onZoomInHandler, className: "react-flow__controls-zoomin", title: "zoom in", "aria-label": "zoom in", disabled: maxZoomReached, children: (0, import_jsx_runtime3.jsx)(PlusIcon, {}) }), (0, import_jsx_runtime3.jsx)(ControlButton, { onClick: onZoomOutHandler, className: "react-flow__controls-zoomout", title: "zoom out", "aria-label": "zoom out", disabled: minZoomReached, children: (0, import_jsx_runtime3.jsx)(MinusIcon, {}) })] }), showFitView && (0, import_jsx_runtime3.jsx)(ControlButton, { className: "react-flow__controls-fitview", onClick: onFitViewHandler, title: "fit view", "aria-label": "fit view", children: (0, import_jsx_runtime3.jsx)(FitViewIcon, {}) }), showInteractive && (0, import_jsx_runtime3.jsx)(ControlButton, { className: "react-flow__controls-interactive", onClick: onToggleInteractivity, title: "toggle interactivity", "aria-label": "toggle interactivity", children: isInteractive ? (0, import_jsx_runtime3.jsx)(UnlockIcon, {}) : (0, import_jsx_runtime3.jsx)(LockIcon, {}) }), children2] });
};
...
function Background({
  ...
  const { transform: transform2, patternId } = useStore2(selector4, shallow);
  ...
  return (0, import_jsx_runtime4.jsxs)("svg", { className: cc(["react-flow__background", className]), style: {
    ...
    top: 0,
    left: 0
  }, ref, "data-testid": "rf__background", children: [(0, import_jsx_runtime4.jsx)("pattern", { id: patternId + id2, x: transform2[0] % scaledGap[0], y: transform2[1] % scaledGap[1], width: scaledGap[0], height: scaledGap[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${patternOffset[0]},-${patternOffset[1]})`, children: isDots ? (0, import_jsx_runtime4.jsx)(DotPattern, { color: patternColor, radius: scaledSize / offset }) : (0, import_jsx_runtime4.jsx)(LinePattern, { dimensions: patternDimensions, color: patternColor, lineWidth }) }), (0, import_jsx_runtime4.jsx)("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${patternId + id2})` })] });
}
...
function NodeToolbarPortal({ children: children2 }) {
  const wrapperRef = useStore2(selector5);
  if (!wrapperRef) {
    return null;
  }
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = {}, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  return (0, import_jsx_runtime6.jsx)("div", { className: cc(["react-flow__resize-control", "nodrag", ...positionClassNames, variant, className]), ref: resizeControlRef, style: controlStyle, children: children2 });
}
...
function NodeResizer({ nodeId, isVisible = true, handleClassName, handleStyle, lineClassName, lineStyle, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [lineControls.map((c) => (0, import_jsx_runtime6.jsx)(ResizeControl$1, { className: lineClassName, style: lineStyle, nodeId, position: c, variant: ResizeControlVariant.Line, color: color2, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd }, c)), handleControls.map((c) => (0, import_jsx_runtime6.jsx)(ResizeControl$1, { className: handleClassName, style: handleStyle, nodeId, position: c, color: color2, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd }, c))] });
}
export {
