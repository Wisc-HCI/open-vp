import"./isSymbol-fd368dfe.js";import{D as a,e as f,l as E,g as y,f as m,T as l,h as N,j as e,i as c,m as C,n as I,k as d}from"./ErrorFallback-5fd8a603.js";import{S as D}from"./Synchronizing-05e47192.js";const _={drawers:[{title:"Structures",dataType:a.INSTANCE,objectTypes:["functionType","operationType","blockType"],icon:f},{title:"Functions",dataType:a.CALL,objectType:"functionType",icon:E},{title:"Hats",dataType:a.REFERENCE,objectType:"hatType",icon:y},{title:"Boots",dataType:a.REFERENCE,objectType:"bootType",icon:m}],objectTypes:{programType:{name:"Program",type:l.OBJECT,description:`# The Program
...
function main() {
  ...
  \`\`\`
      `,instanceBlock:{onCanvas:!0,color:"#3f3f3f",icon:N,extras:[{type:e.INDICATOR_TEXT,accessor:t=>t.properties.children.length,label:"Size"},{type:e.INDICATOR_ICON,accessor:t=>D,label:"Status"},{icon:c,type:e.DROPDOWN,label:"Custom More...",contents:[e.DOC_TOGGLE,e.DEBUG_TOGGLE,e.LOCKED_INDICATOR,e.SELECTION_TOGGLE,e.DIVIDER,{label:"More Options",type:e.DROPDOWN,contents:[e.NAME_EDIT_TOGGLE,e.COLLAPSE_TOGGLE,e.LOCKED_INDICATOR,{type:e.INDICATOR_TEXT,accessor:t=>t.properties.children.length,label:"Size"},{type:e.FUNCTION_BUTTON,onClick:"updateItemBlockColors",label:"Cycle Color",icon:C},{type:e.INDICATOR_ICON,accessor:t=>D,label:"Synchronizing"}]}]},e.DIVIDER,e.LOCKED_INDICATOR]},referenceBlock:null,properties:{children:{name:"Children",accepts:["operationType","functionType","blockType"],default:[],isList:!0,fullWidth:!0}},parsers:{javascript:({block:t,name:s,depth:i,context:n,storeParser:o})=>`function ${s}() {
${t.properties.children.map(r=>o("javascript",r,i+1,n)).join(`;
`)};
};

`},namePolicy:{javascript:t=>t.name.replace(" ","")}},blockType:{name:"Block",type:l.OBJECT,instanceBlock:{onCanvas:!1,color:"#7f7f7f",icon:I,extras:[e.DOC_TOGGLE,e.COLLAPSE_TOGGLE,e.DEBUG_TOGGLE,{type:e.INDICATOR_TEXT,accessor:t=>t.properties.children.length,label:"Size"},{type:e.FUNCTION_BUTTON,onClick:"updateItemBlockColors",label:"Cycle Color",icon:C},e.LOCKED_INDICATOR]},referenceBlock:null,properties:{children:{name:"Children",accepts:["operationType","functionType","blockType"],default:[],isList:!0,fullWidth:!0}}},functionType:{name:"Function",type:l.FUNCTION,instanceBlock:{onCanvas:!0,color:"#62869e",icon:E,extras:[e.LOCKED_INDICATOR,{icon:c,type:e.DROPDOWN,contents:[e.SELECTION_TOGGLE,e.NAME_EDIT_TOGGLE,e.DELETE_BUTTON,e.LOCKED_INDICATOR,e.DOC_TOGGLE,{type:e.ADD_ARGUMENT_GROUP,allowed:["hatType","bootType"]},{type:e.ADD_ARGUMENT,argumentType:"hatType"}]},{type:e.ADD_ARGUMENT_GROUP,allowed:["hatType","bootType"]}]},callBlock:{onCanvas:!1,color:"#62869e",icon:E,extras:[{icon:c,type:e.DROPDOWN,contents:[e.DOC_TOGGLE,e.DELETE_BUTTON]}]},properties:{children:{name:"Children",accepts:["functionType","blockType","operationType"],default:[],isList:!0,fullWidth:!0}},parsers:{javascript:({block:t,name:s,depth:i,context:n,storeParser:o})=>{if(t.dataType===a.INSTANCE)return`function ${s}(${t.arguments.map(r=>o("javascript",r,0,n)).join(", ")}) {
${t.properties.children.map(r=>o("javascript",r,i+1,n)).join(`;
`)}
};
...
//# sourceMappingURL=basicStarter-854550df.js.map
