...
export type Query = "onCanvas"|"color"|"icon"|"extras"|"connections"|"hideNewPrefix"|"minified"|"style";

export function blockSpecQuery(typeSpec: TypeSpec, query: Query, knownMetaType?: MetaType): any {
