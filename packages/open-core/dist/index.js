...
__export(exports, {
  ...
  SIMPLE_PROPERTY_TYPES: () => SIMPLE_PROPERTY_TYPES,
  callTemplateFromSpec: () => callTemplateFromSpec,
  combinedBlockData: () => combinedBlockData,
  instanceTemplateFromSpec: () => instanceTemplateFromSpec,
  referenceTemplateFromSpec: () => referenceTemplateFromSpec
});
...
function functionInstanceAsType(functionTypeSpec, functionInstance, programData) {
  ...
  let functionTypeDef = __spreadProps(__spreadValues({}, initialFunctionDef), {
    properties: __spreadValues(__spreadValues({}, (0, import_lodash.mapValues)(initialFunctionDef.properties, (v) => __spreadProps(__spreadValues({}, v), {
