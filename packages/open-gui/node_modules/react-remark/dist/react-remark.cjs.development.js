...
var remarkToRehype = _interopDefault(require('remark-rehype'));
var rehypeReact = _interopDefault(require('rehype-react'));
...
var useRemark = function useRemark(_temp2) {
  ...
  var setMarkdownSource = react.useCallback(function (source) {
